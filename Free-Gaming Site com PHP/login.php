      ...
      <?php if (isset($_GET['erro'])): ?>
        <div class="alert alert-danger mt-3 text-center">
          <?php 
            ...
            if($_GET['erro'] == 'login_invalido_erro_code_conta_admin') echo "Código de Admin incorreto.";
            if($_GET['erro'] == 'login_invalido_conta_admin') echo "Por favor, marque a opção 'Sou Admin'.";
          ?>
        </div>
      <?php endif; ?>
    </form>
